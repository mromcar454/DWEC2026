...
const person = new Person("Ortiz", 37)
person.greet()
...
const cat = new Cat("AntonioCat")
console.log(cat)
cat.makeSound()

const dog = new Dog("AntonioDog")
console.log(dog)
dog.makeSound()
...
const bird = new Bird("AntonioBird")

console.log(bird.name)
bird.fly()

const dragon = new Dragon("AntonioDragon")
